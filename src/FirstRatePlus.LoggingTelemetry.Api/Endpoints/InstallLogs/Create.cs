 ...
 * It uses the AutoMapper library for object mapping and the Microsoft.Azure.CosmosRepository library for data access.
 */
...
/// <summary>
/// An API endpoint for creating an install log.
/// </summary>
public class Create : Endpoint<CreateInstallLogRequest, CreateInstallLogResponse>
{
    ...
    CancellationToken ct)
  {
    ...
    var response = mapper.FromInstallLogToCreateInstallLogResponse(createdItem);
