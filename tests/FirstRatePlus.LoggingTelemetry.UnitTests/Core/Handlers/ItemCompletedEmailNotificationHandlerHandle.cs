...
using FirstRatePlus.LoggingTelemetry.Core.ProjectAggregate.Events;
using FirstRatePlus.LoggingTelemetry.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace FirstRatePlus.LoggingTelemetry.UnitTests.Core.Handlers;
